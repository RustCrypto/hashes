...
fn ripemd128_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("01eb52529bcec15bd0cb4040ec998632").into(),
    );
}
...
fn ripemd160_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("bcd8c672932125776af3c60eeeb58bbaf206f386").into(),
    );
}
...
fn ripemd256_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("6492ffe075896441b737900bdf58fc960e77477e42a2a61bc02c66fd689b69d0").into(),
    );
}
