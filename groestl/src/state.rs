          ...
          Quot<BlockSize, U8>: ArrayLength<u8>,
{
    ...
    fn block_to_matrix(&self, block: &GenericArray<u8, BlockSize>)
    ...
    fn matrix_to_block(&self, matrix: &Matrix<U8, Quot<BlockSize, U8>>)
    ...
    pub fn p(&self, block: &GenericArray<u8, BlockSize>)
        -> GenericArray<u8, BlockSize>
    {
    ...
    fn q(&self, block: &GenericArray<u8, BlockSize>)
        -> GenericArray<u8, BlockSize>
    {
        let shifts = if self.wide() {
            SHIFTS_Q_WIDE
    ...
    fn add_round_constant(&self, matrix: &mut Matrix<U8, Quot<BlockSize, U8>>,
                          c: [u8; 128], round: u8,
    ) {
    ...
    fn shift_bytes(&self, matrix: &mut Matrix<U8, Quot<BlockSize, U8>>,
                   shifts: [u8; 8],
    ) {
