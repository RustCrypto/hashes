...
fn fsb160_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("40b7538be5e51978690d1a92fe12a7f25f0a7f08").into(),
    );
}
...
fn fsb224_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("0ec203ccec7cbf0cadd32e5dc069d0b4215a104c4dad5444944a0d09").into(),
    );
}
...
fn fsb256_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("eecb42832a2b03bc91beb1a56ddf2973c962b1aeb22f278e9d78a7a8879ebba7").into(),
    );
}
