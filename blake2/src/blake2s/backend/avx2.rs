...
#[inline(always)]
unsafe fn transpose_state_vecs(jobs: &[Job<'_, '_>; DEGREE]) -> [__m256i; 8] {
...
#[inline(always)]
unsafe fn untranspose_state_vecs(h_vecs: &[__m256i; 8], jobs: &mut [Job<'_, '_>; DEGREE]) {
...
#[inline(always)]
unsafe fn load_counts(jobs: &[Job<'_, '_>; DEGREE]) -> (__m256i, __m256i) {
    (
        set8(
...
#[inline(always)]
unsafe fn store_counts(jobs: &mut [Job<'_, '_>; DEGREE], low: __m256i, high: __m256i) {
...
pub unsafe fn compress8_loop(jobs: &mut [Job<'_, '_>; DEGREE], finalize: Finalize, stride: Stride) {
