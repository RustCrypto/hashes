...
use super::{
    ...
    Count, Word, BLOCKBYTES, IV, SIGMA,
};
...
#[inline(always)]
unsafe fn transpose_state_vecs(jobs: &[Job<'_, '_>; DEGREE]) -> [__m128i; 8] {
...
#[inline(always)]
unsafe fn untranspose_state_vecs(h_vecs: &[__m128i; 8], jobs: &mut [Job<'_, '_>; DEGREE]) {
...
#[inline(always)]
unsafe fn load_counts(jobs: &[Job<'_, '_>; DEGREE]) -> (__m128i, __m128i) {
    (
        set4(
...
#[inline(always)]
unsafe fn store_counts(jobs: &mut [Job<'_, '_>; DEGREE], low: __m128i, high: __m128i) {
