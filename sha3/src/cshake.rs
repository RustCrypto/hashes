...
macro_rules! impl_cshake {
    (
        ...
        #[doc = $alg_name]
        #[doc = " XOF reader."]
        pub type $reader_name = XofReaderCoreWrapper<Sha3XofReaderCore<$rate>>;
