...
fn shabal192_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("a3e480026be158db97976a895b7a015e9e5205986ebc8a89").into(),
    );
}
...
fn shabal224_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("a09bedfed92fdffc896e6043ec175aa1f07383c65bde990a3661e3d0").into(),
    );
}
...
fn shabal256_rand() {
    ...
    assert_eq!(
        h.finalize(),
        hex!("53252a6467450aa1afc1ac25efb493aa65b70e5b2280a4bed7f672c0cfe6f40e").into(),
    );
}
