...
fn grostl_224_main() {
    ...
    main_test::<grostl::GrostlSmall<U224>>(&tests);
}
...
fn grostl_256_main() {
    ...
    main_test::<grostl::GrostlSmall<U256>>(&tests);
}

#[test]
fn grostl_384_main() {
    let tests = new_tests!("grostl384/test1");
    main_test::<grostl::GrostlBig<U384>>(&tests);
}

#[test]
fn grostl_512_main() {
    let tests = new_tests!("grostl512/test1");
    main_test::<grostl::GrostlBig<U512>>(&tests);
}
